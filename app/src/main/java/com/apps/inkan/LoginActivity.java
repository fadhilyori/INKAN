...
//
        ...
        APIService.service_post.postLogin(username, password).enqueue(new Callback<LoginModel>() {
            ...
            public void onResponse(Call<LoginModel> call, Response<LoginModel> response) {
                ...
                if(response.body().isStatus()) {
                    ...
                    assignConstanta(response.body().getUsername());
                    assignConstanta2(response.body().getEmail());
    ...
    private void assignConstanta (String username) {UserConstant.username = username; }
    private void assignConstanta2 (String email) {UserConstant.email = email; }
}